...
class _DiaryFormState extends State<DiaryForm> {
  ...
  void _saveEntry() {
    if (_formKey.currentState!.validate()) {
      ...
      if (_image != null) {
        uploadImageToFirebase(_image!).then(
          (value) => {
            diaryProvider.addEntryWithImage(DiaryEntry(
                title: "Nova entrada",
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                  borderSide:
                      BorderSide(color: Color.fromRGBO(128, 196, 233, 1)),
                  borderRadius: BorderRadius.circular(20),
                ),
                focusedBorder: OutlineInputBorder(
                  borderSide: BorderSide(
                      color: Color.fromRGBO(19, 75, 112, 1), width: 2),
                  borderRadius: BorderRadius.circular(20),
                ),
                hintText: 'Hoje eu...',
